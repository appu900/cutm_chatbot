...
const config = {
  accessToken:
    "EAAHiMA9Pw4ABO4d3de1oghtJnpcPdkDJZBdtygwZABiSzmjx6ZB1mEF2SWGnUT71WCdA0t3N8gWzzb87tVqyCAatExpe4F2ytxjfQxsJI1qiIU8HpsnpbXYxEhqTNArOe86B8L2Y4KMKuwLNOLB4oZCvdpCCqE7AcJjUb5PN1qfiHLo6Cf9jpUq2SKj1v6B3FQZDZD", // Replace with your actual token
...
async function sendTemplateMessage(
  ...
  async function sendTemplateMessageInner(
    ...
    try {
      ...
      console.log(
        `Template message "${templateName}" sent to ${to}:`,
        response.data
      );
    } catch (error: any) {
      console.error(
      ...
      if (messageType === "text") {
        ...
        if (text === "hi" || text === "hello") {
          ...
          await sendTemplateMessage(
            from,
            "Sorry, I couldn't understand that. Type 'hi' to begin."
          );
        }
